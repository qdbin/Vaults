...
var DayAndNight = class extends import_obsidian2.Plugin {
  ...
  getThemeToApply() {
    const dayDate = (0, import_moment.default)(this.settings.dayTime, import_moment.default.HTML5_FMT.TIME).toDate();
    const nightDate = (0, import_moment.default)(this.settings.nightTime, import_moment.default.HTML5_FMT.TIME).toDate();
